...
import static com.neotys.action.argument.DefaultArgumentValidator.URL_VALIDATOR;
...
enum ClickOnLinkByHrefOption implements Option {

    Href("Href", Required, True, TEXT,
            "Url of the link to click",   "Url of the link to click",
            NON_EMPTY),
    ...
    ClickOnLinkByHrefOption(final String name, final Option.OptionalRequired optionalRequired,
