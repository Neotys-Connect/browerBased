...
enum SetTextonElementByIDOption implements Option {
    ...
    SetTextonElementByIDOption(final String name, final Option.OptionalRequired optionalRequired,
