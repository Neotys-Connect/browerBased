...
enum  ClickOnElementByIDOption implements Option {

    Elementid("Elementid", Required, True, TEXT,
            "Element id of the dom to click on",
    ...
    ClickOnElementByIDOption(final String name, final Option.OptionalRequired optionalRequired,
