...
enum  ClickElementByXpathOption implements Option {

    Xpath("Xpath", Required, True, TEXT,
            "xpath to click on the  dom element",
                    "xpath  of the element of the dom",
          NON_EMPTY),
    ...
    ClickElementByXpathOption(final String name, final Option.OptionalRequired optionalRequired,
