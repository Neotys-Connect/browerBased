...
public class ClickElementByXpathActionEngine implements ActionEngine {


    private static final String STATUS_CODE_INVALID_PARAMETER = "NL-BT-CLICKBYXPATH_TION-01";
    private static final String STATUS_CODE_TECHNICAL_ERROR = "NL-BT-CLICKBYXPATH-02";
    private static final String STATUS_CODE_BAD_CONTEXT = "NL-BT-CLICKBYXPATH-03";
    ...
    public SampleResult execute(Context context, List<ActionParameter> parameters) {
        ...
        try {
            parsedArgs = parseArguments(parameters, ClickElementByXpathOption.values());
