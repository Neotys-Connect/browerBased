...
enum SelectItemFromListByNameOption  implements Option {

    Name("Name", Required, True, TEXT,
            "Name of the dom to set text",
    ...
    SelectItemFromListByNameOption(final String name, final Option.OptionalRequired optionalRequired,
