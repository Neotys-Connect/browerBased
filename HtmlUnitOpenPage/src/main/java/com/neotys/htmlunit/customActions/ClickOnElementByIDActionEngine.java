...
public class ClickOnElementByIDActionEngine implements ActionEngine {
    ...
    public SampleResult execute(Context context, List<ActionParameter> parameters) {
        ...
        try {
            parsedArgs = parseArguments(parameters, ClickOnElementByIDOption.values());
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("Executing " + this.getClass().getName() + " with parameters: "
                    + getArgumentLogString(parsedArgs, ClickOnElementByIDOption.values()));
        }
