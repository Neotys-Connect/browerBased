...
public class SelectItemFromListByIdAction implements Action {
    private static final String BUNDLE_NAME = "com.neotys.htmlunit.customActions.SelectItemFromListById.bundle";
    private static final String DISPLAY_NAME = ResourceBundle.getBundle(BUNDLE_NAME, Locale.getDefault()).getString("displayName");
    private static final String DISPLAY_PATH = ResourceBundle.getBundle(BUNDLE_NAME, Locale.getDefault()).getString("displayPath");

    @Override
    public String getType() {
        return "SelectItemFromListById";
    }
    ...
    public Class<? extends ActionEngine> getEngineClass() {
        return SelectItemFromListByIdActionEngine.class;
    }
    ...
    public String getDescription() {
        return "Select elment in a dropdown list .\n\n" + Arguments.getArgumentDescriptions(SelectItemFromListByIdOption.values());
