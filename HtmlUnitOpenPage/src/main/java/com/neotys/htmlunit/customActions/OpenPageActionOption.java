...
enum OpenPageActionOption implements Option {

    URL("URL", Required, True, TEXT,
            "Url Of the website to test",
                    "Url Of the website to test",
                          URL_VALIDATOR),
    BrowserVersion("BrowserVersion", Required, True, TEXT,
            "Browser to emulate : CHROME,INTERNET_EXPLORER,FIREFOX_60,FIREFOX_68",
                    "Browser version to emulate",
         NON_EMPTY),
    ProxyHost("ProxyHost", Optional, False, TEXT,
            "Keystore of the from account ",
                    "Keystore of the from account ",
               NON_EMPTY),
    ProxyPORT("ProxyPORT", Optional, False, TEXT,
            "Keystore of the from account ",
                    "Keystore of the from account ",
              INTEGER_VALIDATOR),
    Performance("Performance", Optional, True, TEXT,
            ...
            BOOLEAN_VALIDATOR),
    ClearCache("ClearCache", Optional, True, TEXT,
            "if true it will clear the cache before interacting with the browser . Value possible true/false",
            "if true it will clear the cache before interacting with the browser . Value possible true/false",
            BOOLEAN_VALIDATOR),
    ClearCookie("ClearCookie", Optional, True, TEXT,
            "if true it will clear the cookies before interacting with the browser. Value possible true/false",
            "if true it will clear the cookie before interacting with the browser. Value possible true/false ",
            BOOLEAN_VALIDATOR),
    ...
    OpenPageActionOption(final String name, final Option.OptionalRequired optionalRequired,
